package com.hour24.tumblershare.view;
...
//                Log.d(TAG, "cubic to " + currentPointX + ", " + currentPointY);
    ...
    public void addDefaultWaves(int right, int left) {
        for (int i = 0; i < right; i++) {
            addWaveData(new WaveData((float) (800 + Math.random() * 100), (float) (100 + Math.random() * 20), (float) (200 + Math.random() * 20), (float) (Math.random() * 50), ContextCompat.getColor(getContext(), R.color.colorAccent), ContextCompat.getColor(getContext(), R.color.colorAccent), 0.3f, (long) (3000 + Math.random() * 1000), true));
        }

        for (int i = 0; i < left; i++) {
            addWaveData(new WaveData((float) (800 + Math.random() * 100), (float) (100 + Math.random() * 20), (float) (200 + Math.random() * 20), (float) (Math.random() * 50), ContextCompat.getColor(getContext(), R.color.colorAccent), ContextCompat.getColor(getContext(), R.color.colorAccent), 0.3f, (long) (3000 + Math.random() * 1000), false));
        }
    }
